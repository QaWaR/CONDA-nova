            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-campaign card mb-4">
                        <a href="single-campaign"><img src="images/armywings/armywings.jpg" class="card-img-top">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-campaign card mb-4">
                        <a href="single-campaign"><img src="images/darts/dartcover.jpg" class="card-img-top">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-campaign card bg-light mb-4">
                        <div class="position-relative">
                            <a href="single-campaign"><img class="card-img-top" src="images/campaigns/m-office.jpg">
                        </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 text-center text-sm-left mb-3">
                                        ...
                                        <p class="mb-0 font-weight-bold">10.000
                                            <sup>€</sup>
                                        </p>
                                        <p class="text-muted small">Minimum investment</p>
                                        <p class="mb-0 text-muted small">HERO token</p>
                                        <p class="mb-0 font-weight-bold">400.000
                                            <sup>€</sup>
                                        </p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-campaign card bg-light mb-4">
                        <div class="position-relative">
                            <a href="single-campaign"><img class="card-img-top" src="images/campaigns/intechor.jpg">
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 text-center text-sm-left mb-3">
                                        <p class="mb-0 font-weight-bold">55.000
                                            <sup>€</sup>
                                        </p>
                                        <p class="text-muted small">Minimum investment</p>
                                        <p class="mb-0 font-weight-bold">550.000
                                            <sup>€</sup>
                                        </p>
                                        <p class="text-muted small">Maximum investment</p>
                                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-campaign card bg-light mb-4">
                        <div class="position-relative">
                            <a href="single-campaign"><img class="card-img-top" src="images/campaigns/makit.jpg">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-campaign card bg-light mb-4">
                        <div class="position-relative">
                            <a href="single-campaign"><img class="card-img-top" src="images/campaigns/oceanic-travel.jpg">
                        </div>
                        <div class="card-body bg-secondary d-flex justify-content-between align-items-center text-white">
                        ...
                        <div class="single-campaign card">
                            ...
                            <div class="card-body text-dark bg-light">
                                <div class="card-title d-flex justify-content-start align-items-center mb-3">
                                    ...
                                    <a href="single-campaign.php"><h4 class="company-name card-title">Medix (CF)</h4></a>
                                </div>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="news-single card p-2 mb-4">
                    ...
                    <div class="card-body p-0 text-dark">
                        ...
                        <p class="news-summary card-text text-dark mt-3">Maecenas imperdiet arcu id urna fringilla suscipit. Nullam non luctus mauris. Aliquam at orci ut metus congue dapibus.
                ...
                <div class="news-single card p-2 mb-4">
                    <div class="card-body p-0 text-dark">
                        ...
                        <div class="date-author d-flex align-items-baseline">
                            <i class="far fa-clock mr-1 text-muted"></i>
                            <p class="card-subtitle text-muted">December 11, 2017 By
                                <span>
                                    <a href="" class="text-success">admin </a>
                                </span> in
                                <span>
