        ...
        <div class="carousel-inner">
            <div class="carousel-item active bg-warning">
                <div class="container">
                    ...
                    <button class="btn btn-danger border border-danger w-lg-100 mb-3">
                        Für Unternehmer
                    </button>
                    <button class="btn btn-success border border-success w-lg-100 ml-3 mb-3">
                        Für Investoren
                    </button>
                </div>
            </div>
                        ...
                        <div class="card bg-light mb-4">
                            <div class="position-relative">
                                ...
                                <div class="card-img-overlay">
                                    <div class="bg-warning rounded d-inline-block px-2 py-1">
                                        <i class="fas fa-star text-white"></i>
                                        <span class="px-2 text-white">Favourite</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="card bg-light mb-4">
                            <div class="position-relative">
                                ...
                                <div class="card-img-overlay">
                                    <div class="bg-success rounded d-inline-block px-2 py-1">
                                        <i class="fas fa-heart text-white"></i>
                                        <span class="px-2 text-white">Successfully financed</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body bg-secondary d-flex justify-content-between align-items-center text-white">
